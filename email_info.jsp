...
<body>
	...
	<div class="register">
		...
		<section class="emp_reg">
			...
			<form:form id="form" action="user_info" method="post"
				modelAttribute="user" onsubmit="return validateForm()">

				 <h3 style="padding: 10px;color: #009688" class="text-center">Register</h3>
				<div class="step-row">
					<div id="progress"></div>
					<div class="step-col1"><small style="color: #009688"><b>Basic details</b></small></div>
...
function form_submit() {
	$(location).attr('href', '${contextRoot}/emp/emp_register')
}
